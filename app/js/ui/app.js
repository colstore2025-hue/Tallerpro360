...
.onclick = () => finanzas(container.querySelector("#appContentInner"));
...
const ordenes = snapshot.docs.filter(
d => d.data().empresaId === empresaId
);
...
const ia = await detectarRepuestos(texto);
...
/* ===============================
MÓDULO REPUESTOS (BÁSICO)
=============================== */

export function repuestos(container){
