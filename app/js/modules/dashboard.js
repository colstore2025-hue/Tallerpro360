...
================================================
dashboard.js
Panel avanzado gerente TallerPRO360 ERP
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:20px;margin-bottom:25px;">
  ...
  <div class="card"><h3>Margen de utilidad promedio</h3><p id="margenUtilidad" style="font-size:28px;">0%</p></div>
  <div class="card"><h3>Tiempo promedio de reparación</h3><p id="tiempoPromedio" style="font-size:28px;">0h</p></div>
  <div class="card"><h3>Stock crítico</h3><p id="stockCritico" style="font-size:28px;">0</p></div>
  <div class="card"><h3>Ingresos vs. Pagos</h3><p id="resumenIngresosHoy" style="font-size:28px;">$0</p></div>
</div>
