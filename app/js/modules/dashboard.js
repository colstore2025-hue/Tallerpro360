...
const PERMISOS = {
    ...
    "PRO": { 
        modulos: ['clientes', 'vehiculos', 'ordenes', 'inventario', 'pagos', 'contabilidad', 'gerenteAI', 'reportes', 'marketplace.html', 'publish.html', 'soporte'],
        clase: "border-purple-500 text-purple-400 shadow-[0_0_20px_rgba(168,85,247,0.2)]"
    },
    "ELITE": { 
        modulos: ['clientes', 'vehiculos', 'ordenes', 'inventario', 'pagos', 'contabilidad', 'gerenteAI', 'reportes', 'marketplace.html', 'publish.html', 'staff', 'nomina', 'finanzas_elite', 'soporte'],
...
function renderInterface(container, plan, config) {
    ...
    <div id="nexus-aegis-view" class="p-6 lg:p-12 space-y-12 animate-in fade-in duration-1000 pb-48 max-w-[1800px] mx-auto bg-[#010409]">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 gap-6">
            ...
            ${renderBtn('MarketX', 'fa-globe', '#marketplace.html', config.modulos.includes('marketplace.html'))}
            ${renderBtn('Nueva Misión', 'fa-plus-circle', '#publish.html', config.modulos.includes('publish.html'))}
